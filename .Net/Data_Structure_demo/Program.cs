namespace Data_Structure_demo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            students_ll.AddFirst(first);
            students_ll.AddFirst(second);
            students_ll.AddFirst(third);

            foreach (Student student in students_ll)
            {
                Console.WriteLine(student.id);
            }
            Console.WriteLine(students_ll.First().name);

            //Tuple
            Console.WriteLine("Tuple");
            Tuple<Student,Student,Student> students_tp = new Tuple<Student,Student,Student>(first,second,third);
            Console.WriteLine(students_tp.Item1.name);
